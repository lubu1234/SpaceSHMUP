...
public class PowerUp : MonoBehaviour {
	...
	public Weapon.WeaponType type; //The type of the PowerUp
	public GameObject cube; //Referece to the Cube child
	...
	void Awake(){
		...
		//Noramlizing a Vector3 makes it length 1m
	...
	void Update(){
		...
		//Given the default values, a PowerUp will exst for 10 seconds and then fade out every 4 seconds
