...
//===========Bounds function====//
	...
	//Creates bounds that encapsulate the two Bounds in.
	...
	//This function is used by camBounds to set_camBounds and can also be called directly.
	...
	public static Vector3 BoundsInBoundsCheck (Bounds bigB, Bounds lilB, BoundsTest test = BoundsTest.onScreen){
		...
		//The behavior of this function is different based on the BoundsTest that is selected
