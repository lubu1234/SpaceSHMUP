...
public class Enemy_2 : Enemy {
	...
	//Enemy_2 uses a Sin wave to modif a 2-point linear interpolation
	...
	void Start(){
		...
		if (Random.value < 0.5f) {
			...
			//Seeting the .x of each point to its negative will move it to the other side of the screen
			points [0].x *= -1;
			points [1].x *= -1;
